...
cat >> ./.bash_profile <<- EOM
  case "'$USER'" in 
  *-ocaml-4.12) export PATH="/Users/administrator/ocaml/4.12.0/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:/Library/Frameworks/Mono.framework/Versions/Current/Commands:/usr/local/bin";;
